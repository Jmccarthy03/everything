	...
	if (passInput === "Adminpass" && nameInput === "Admin")  window.location.href = "ulhome.html";
		else if (passInput === "T@nn3r" && nameInput === "Tman")  window.location.href = "ulhome.html";
		...
		else if (passInput === "bypass" && nameInput === "bypass")  window.location.href = "ulhome.html";
		}
